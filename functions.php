...
function bcn_scripts() {
	...
	wp_enqueue_script( 'bcn-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'bcn-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
 ...
 * Theme Options
 */
if ( !isset( $bcn_options ) && file_exists( get_template_directory() . '/inc/theme-options.php' ) ) {
