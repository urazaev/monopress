		...
		<main class="page-main">
			<section class="portfolio portfolio--masonry">
				<div class="uk-container uk-container-large">
					<div class="uk-margin-small-top" data-uk-filter="target: .js-filter">
						...
						<ul class="portfolio__list js-filter uk-child-width-1-2 uk-child-width-1-3@m uk-text-center" data-uk-grid="masonry: true" <?php if ($theme_options['portfolio-show-modal'] == '1'){ ?>data-uk-lightbox="animation: fade"<?php } ?>>
							...
							<?php if ($loop) :
								...
								while ($loop->have_posts()) : $loop->the_post(); ?>
									...
									<li class="portfolio__item" data-type="<?php echo $tax; ?>" data-name="A<?php echo $post->ID?>">
