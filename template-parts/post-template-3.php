...
?>
			...
			<div class="post-block-20_inner">
				<article class="post-block-20__item">
					...
					if ($theme_options['post-show-categories'] == 1) { ?>
						<p class="post-block-20__wrapper-link  has-animation animation-rtl animate-in">
							<?php
							$thelist = '';
							$i = 0;
					...
					if ($theme_options['post-featured-images-show'] == 1) { ?>
						...
						<figure class="post-block-20__img has-animation animation-ltr animate-in">
	...
	<div class="post-block-20__wrapper-text <?php if (($theme_options['post-show-categories'] == 1) || $theme_options['post-featured-images-show'] == 1 || $theme_options['block-show-tags'] == 1 || $theme_options['block-show-next-previous'] == 1 || $theme_options['block-show-author-box'] == 1 || $theme_options['post-related-show'] == '1') { echo "post-block-20__wrapper-text--semiwidth";} else {echo "post-block-20__wrapper-text--fullwidth";}?>">
