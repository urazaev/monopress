...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'id' => 'instagram-images',
            'type' => 'select',
            'title' => __('Number of images per row', 'bcn'),
            'subtitle' => __('Set the number of images displayed on each row (default is 3)', 'bcn'),
        ...
        array(
            ...
            'id' => 'instagram-rows',
            'type' => 'select',
            'title' => __('Number of rows', 'bcn'),
            'subtitle' => __('Set on how many rows to display the images (default is 1)', 'bcn'),
            //Must provide key => value pairs for select options
            'options' => array(
                '1' => '1',
                '2' => '2',
